...
#import "ScreensOverlay.h"

@interface RNScreensOverlay () <RCTInvalidating>
@end
...
@implementation RNScreensOverlay {
...
@implementation RNScreensOverlayManager

RCT_EXPORT_MODULE()

- (UIView *)view
{
  return [[RNScreensOverlay alloc] initWithBridge:self.bridge];
}
